...
const Pricing = () => {
  return (
    <div className="w-full xl:mt-[-180px] md:items-center md:justify-center
     ...
     bg-grid-white/[0.02] relative overflow-hidden">
      ...
      <div className="flex items-center justify-center flex-col">
        ...
        <div className="grid grid-cols-1  mt-8  md:grid-cols-2 lg:grid-cols-3 gap-6 md:w-4/5 cursor-pointer pb-6  items-start ">
