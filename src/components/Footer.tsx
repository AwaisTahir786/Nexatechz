    ...
    <>
      <footer className="border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          {/* <!-- Footer Top --> */}
          <div className="py-20 lg:py-25 px-20">
...
<Link href="#contact">
<p className="mb-1.5 text-sectiontitle uppercase tracking-[5px] cursor-pointer">
                  contact
                </p>
              ...
              <div className=" flex w-full flex-col gap-8 md:flex-row  md:justify-between  md:gap-0 lg:w-2/3 xl:w-7/12">
                ...
                >
                 <div className="lg:ml-[8rem] lg:flex flex-col items-center justify-center">
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <ul className="flex items-center gap-8">
                ...
                <li>
                  <a href="https://servelogy.com/privacy-policy/" className="hover:text-primary">
                    Privacy Policy
                  </a>
                </li>
                <li>
            ...
            >
              <p>
                &copy;  Copyright SERVELOGY TECHNOLOGIES (OPC) PRIVATE LIMITED. All Rights Reserved
              </p>
            </motion.div>
