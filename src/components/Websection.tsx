    ...
    <div className="relative">
        <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8 ">
            <div className="mx-auto max-w-xl px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0 ">
                ...
                <div>
                    <div>
                        <span className="flex h-12 w-12 items-center  justify-center rounded-xl bg-[#39FF14]">
                    ...
                    <div className="mt-6">
                        ...
                        <div className="mt-6">
                            <a className="inline-flex rounded-lg bg-black border-[#39FF14] border-2 px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1 ring-[#39FF14] hover:text-[#39FF14] hover:ring-[#39FF14]"
                                href="/login">
                                Learn More
                            </a>
                        </div>
            ...
            <div className="mt-12 sm:mt-16 lg:mt-0">
                <div className="-mr-48 pl-6 md:-mr-16 lg:relative lg:m-0 lg:h-full lg:px-0">
                    <Image loading="lazy" width="647" height="486"
                        ...
                        alt='web-img' src="https://images.unsplash.com/photo-1569144157591-c60f3f82f137"/>
                </div>
            </div>
        </div>
    </div>
    ...
    {/* <div className="relative">
        <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8 ">
            <div className="mx-auto max-w-xl px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0 lg:col-start-2">
                <div>
                    <div>
                        <span className="flex h-12 w-12 items-center justify-center text-black rounded-xl bg-[#39FF14]">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" aria-hidden="true"
                                className="h-8 w-8 text-black">
                                <path stroke-linecap="round" stroke-linejoin="round"
