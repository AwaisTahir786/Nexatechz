...
const Pricingweb = () => {
  return (
    <div className="w-full md:mt-16 mt-14  md:items-center md:justify-center
     ...
     bg-grid-white/[0.02] relative overflow-hidden">
      ...
      <div className="flex items-center justify-center flex-col">
        ...
        <div className="grid md:grid-cols-2 grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 mt-6 gap-6 md:w-4/5 cursor-pointer pb-6  items-start ">
