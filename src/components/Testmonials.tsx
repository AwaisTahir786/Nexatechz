  ...
  <div className='text-3xl md:mb-14 font-bold pb-10 md:pb-4 text-[#39FF14] md:text-4xl text-center bg-clip-text '>
      ...
      <div className=" mx-auto mb-10 ">
        <div className="grid gap-6 max-w-screen md:px-40 lg:grid-cols-2 xl:grid-cols-3">
            ...
            <div className="flex flex-col justify-between text-md font-extralight w-full border-2 border-[#39FF14] h-full	 px-6 py-6 bg-black md:px-10 rounded-2xl md:py-10   dark:bg-trueGray-800">
            ...
            <div className="flex flex-col text-md font-extralight justify-between border-2 border-[#39FF14] w-full h-full	 px-6 py-6 bg-black md:px-10 rounded-2xl md:py-10   dark:bg-trueGray-800">
                    <p className="leading-normal text-white">
                ...
                {/* Ad more */}
                <div className="flex flex-col border-2 text-md font-extralight border-[#39FF14] justify-between w-full h-full	 px-6 py-6 bg-black md:px-6 rounded-2xl md:py-10   dark:bg-trueGray-800">
            ...
            <div className="flex flex-col justify-between text-md font-extralight border-2 border-[#39FF14] w-full h-full	 px-6 py-6 bg-black md:px-10 rounded-2xl md:py-10   dark:bg-trueGray-800">
                    <p className=" leading-normal text-white">
